      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="relative p-6 rounded-2xl border border-zinc-800 bg-zinc-900/30 backdrop-blur-sm">
            ...
            <h3 className="text-xl font-semibold mb-2 text-orange-400">1. Collect Fees</h3>
            <p className="text-zinc-500 text-sm">1% of BNKRSTR sell volume accumulates as dev fees in ETH</p>
          </div>
        ...
        <div className="mt-12 p-6 rounded-2xl border border-green-500/30 bg-green-500/5">
